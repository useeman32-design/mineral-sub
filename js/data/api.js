...
import { STATES, DEPOSITS, COMMODITIES, ACTIVITY, RESOURCE_META } from './fixtures.js?v=1b88c83';
import { seeded } from '../core/utils.js?v=1b88c83';
import { liveMode, getLiveTitles, getLiveStates, getLiveNational, loadProtectedAreas, loadSettlements, loadProduction, loadOverlap } from './live.js?v=1b88c83';
  ...
  async getDatasets() {
    ...
    const LIVE = {
      ...
      occurrence: { name: 'Mineral occurrence register', status: 'Partial',
        ...
        note: 'Interim coverage. Not the NGSA National Mineral Occurrence Database.' },
      commodity: { name: 'Commodity register', status: 'Connected',
        source: 'Derived: MCO cadastre × NEITI 2023', format: 'JSON', sizeMb: 0.02,
        records: 111, quality: 90, updated: '22 Aug 2026',
        licence: 'Nigerian Government public data',
        note: '111 commodities named across the cadastre; 44 of them carry audited 2023 production.' },
      petroleum: { status: 'Sample data', source: 'NMI placeholder — NUPRC endpoints unavailable',
        note: 'Every published NUPRC data endpoint returned an error; no authoritative block geometry could be sourced.' },
    ...
    const extra = [
      ...
      { id: 'overlap', name: 'Cadastre overlap analysis', domain: 'Analytics',
        ...
        licence: 'Derived from source licences',
        note: '515 licensed blocks intersect 87 protected areas; 61 satellite-mapped workings sit outside any licence.' },
