...
import { ctx } from '../core/context.js?v=4a57f31';
import { icon } from '../core/icons.js?v=4a57f31';
import { $, $$, fmt, sparkline, ring } from '../core/utils.js?v=4a57f31';
import { NigeriaMap, zoomBand } from '../components/map.js?v=4a57f31';
import { RESOURCE_META } from '../data/fixtures.js?v=4a57f31';
import { toast } from './dashboard.js?v=4a57f31';
import { reports } from '../core/reports.js?v=4a57f31';
import { DrawEngine, TOOL_META } from '../components/draw.js?v=4a57f31';
import { History } from '../core/history.js?v=4a57f31';
import { projects } from '../data/projects.js?v=4a57f31';
import { measureShape } from '../core/geo.js?v=4a57f31';
import { loadPrefs } from './settings.js?v=4a57f31';
import { LAYER_GROUPS, LAYER_INDEX, applyLayer } from '../data/layers.js?v=4a57f31';
import { dsToggles, DATASET_LAYER } from '../data/toggles.js?v=4a57f31';
import { Tracker, route as osrmRoute, haversine, fmtDistance, fmtDuration } from '../core/geolocate.js?v=4a57f31';
import { createLegend, LEGEND_RESOURCES } from '../components/legend.js?v=4a57f31';
import { createStatusBar } from '../components/statusbar.js?v=4a57f31';
import { makeDraggable, makeDockResizer } from '../components/draggable.js?v=4a57f31';
