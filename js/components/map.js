...
import { HEAT, RESOURCE_META } from '../data/fixtures.js?v=1b88c83';
import { fmt } from '../core/utils.js?v=1b88c83';
...
export class NigeriaMap {
  ...
  async setFootprints(on) {
    ...
    const { loadFootprints } = await import('../data/live.js?v=1b88c83');
  ...
  async setTitleBlocks(on) {
    ...
    const { loadTitlePolygons, loadTitleAttributes } = await import('../data/live.js?v=1b88c83');
  ...
  async setConflicts(on) {
    ...
    const { loadTitlePolygons, loadOverlap, loadTitleAttributes } =
      await import('../data/live.js?v=1b88c83');
  ...
  async setRoads(on) {
    ...
    const { loadRoads } = await import('../data/live.js?v=1b88c83');
  ...
  async setMineralSites(on) {
    ...
    const { loadMineralSites } = await import('../data/live.js?v=1b88c83');
