...
import { HEAT, RESOURCE_META } from '../data/fixtures.js?v=8503cca';
import { fmt } from '../core/utils.js?v=8503cca';
...
export class NigeriaMap {
  ...
  async setFootprints(on) {
    ...
    const { loadFootprints } = await import('../data/live.js?v=8503cca');
  ...
  async setTitleBlocks(on) {
    ...
    const { loadTitlePolygons, loadTitleAttributes } = await import('../data/live.js?v=8503cca');
  ...
  async setConflicts(on) {
    ...
    const { loadTitlePolygons, loadOverlap, loadTitleAttributes } =
      await import('../data/live.js?v=8503cca');
  ...
  async setRoads(on) {
    ...
    const { loadRoads } = await import('../data/live.js?v=8503cca');
  ...
  async setMineralSites(on) {
    ...
    const { loadMineralSites } = await import('../data/live.js?v=8503cca');
