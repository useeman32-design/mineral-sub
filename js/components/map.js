...
import { HEAT, RESOURCE_META } from '../data/fixtures.js?v=e68ba8c';
import { fmt } from '../core/utils.js?v=e68ba8c';
...
export class NigeriaMap {
  ...
  async setFootprints(on) {
    ...
    const { loadFootprints } = await import('../data/live.js?v=e68ba8c');
  ...
  async setTitleBlocks(on) {
    ...
    const { loadTitlePolygons, loadTitleAttributes } = await import('../data/live.js?v=e68ba8c');
  ...
  async setConflicts(on) {
    ...
    const { loadTitlePolygons, loadOverlap, loadTitleAttributes } =
      await import('../data/live.js?v=e68ba8c');
  ...
  async setRoads(on) {
    ...
    const { loadRoads } = await import('../data/live.js?v=e68ba8c');
  ...
  async setMineralSites(on) {
    ...
    const { loadMineralSites } = await import('../data/live.js?v=e68ba8c');
