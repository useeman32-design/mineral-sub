...
import { HEAT, RESOURCE_META } from '../data/fixtures.js?v=5814b22';
import { fmt } from '../core/utils.js?v=5814b22';
...
export class NigeriaMap {
  ...
  async setFootprints(on) {
    ...
    const { loadFootprints } = await import('../data/live.js?v=5814b22');
  ...
  async setTitleBlocks(on) {
    ...
    const { loadTitlePolygons, loadTitleAttributes } = await import('../data/live.js?v=5814b22');
  ...
  async setConflicts(on) {
    ...
    const { loadTitlePolygons, loadOverlap, loadTitleAttributes } =
      await import('../data/live.js?v=5814b22');
  ...
  async setRoads(on) {
    ...
    const { loadRoads } = await import('../data/live.js?v=5814b22');
  ...
  async setMineralSites(on) {
    ...
    const { loadMineralSites } = await import('../data/live.js?v=5814b22');
