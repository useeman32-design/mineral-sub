...
import { HEAT, RESOURCE_META } from '../data/fixtures.js?v=acb5907';
import { fmt } from '../core/utils.js?v=acb5907';
...
export class NigeriaMap {
  ...
  async setFootprints(on) {
    ...
    const { loadFootprints } = await import('../data/live.js?v=acb5907');
  ...
  async setTitleBlocks(on) {
    ...
    const { loadTitlePolygons, loadTitleAttributes } = await import('../data/live.js?v=acb5907');
  ...
  async setConflicts(on) {
    ...
    const { loadTitlePolygons, loadOverlap, loadTitleAttributes } =
      await import('../data/live.js?v=acb5907');
  ...
  async setRoads(on) {
    ...
    const { loadRoads } = await import('../data/live.js?v=acb5907');
  ...
  async setMineralSites(on) {
    ...
    const { loadMineralSites } = await import('../data/live.js?v=acb5907');
